...
public final class TableProperties implements Cloneable
{
    ...
    /**
     * property <code>auto.generate.paging.fields</code>.
     */
    public static final String PROPERTY_STRING_AUTO_GENERATE_PAGING_FIELDS = "auto.generate.paging.fields"; //$NON-NLS-1$    
    ...
    /**
     * Is the given auto.generate.paging.fields option enabled?
     * @return boolean true if auto.generate.paging.fields is true
     */
    public boolean getAutoGeneratePagingFields()
    {
        return getBooleanProperty(PROPERTY_STRING_AUTO_GENERATE_PAGING_FIELDS);
    }    
