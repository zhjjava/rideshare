...
public class TableTag extends HtmlTableTag
{
    ...
    /**
     * Uses for if needs to render paging.banner.placement.
     */
    private boolean renderPagingBannerPlacement = true;     
    // -- end tag attributes --
    ...
    /**
	 * @param renderPagingBannerPlacement renderPagingBannerPlacement 设定。
	 */
	public void setRenderPagingBannerPlacement(boolean renderPagingBannerPlacement) {
		this.renderPagingBannerPlacement = renderPagingBannerPlacement;
	}
    ...
    public int doStartTag() throws JspException
    {
        ...
        //if render paging banner placement
        this.tableModel.setRenderPagingBannerPlacement(this.renderPagingBannerPlacement);
        //log.debug("this.renderPagingBannerPlacementttttttttt:" +this.renderPagingBannerPlacement);
        initParameters();
    ...
    public void release()
    {
        ...
        this.form = null;
        this.renderPagingBannerPlacement = true;
    }
