...
public class Pagination
{
    ...
    public String getFormattedBanner(String numberedPageFormat, String numberedPageSelectedFormat,
        String numberedPageSeparator, String fullBanner, int pageSize)
    {
        ...
        Object[] pageObjects = {
            ...
            getDropdownPageSizeList(pageSize)
    ...
    private String getDropdownPageSizeList(int currentPageSize){
	    String str ="<select class=\"form-control\" name=\"pageSize\" onchange=\"javascript:this.form.pageNumber.value=1;this.form.submit();\">" +
	    		"<option value=\"2\" " + getIfCheckedStr(currentPageSize,2) +"> 2 </option>" +
	    		"<option value=\"10\" " + getIfCheckedStr(currentPageSize,10) +"> 10 </option>" +
	    		"<option value=\"25\" " + getIfCheckedStr(currentPageSize,25) +"> 25 </option>" +	    		
	    		"<option value=\"50\" " + getIfCheckedStr(currentPageSize,50) +"> 50 </option>" +
	    		"<option value=\"100\" " + getIfCheckedStr(currentPageSize,100) +"> 100 </option>" +
	    		"</select>";
	    return str;
    }
    private String getIfCheckedStr(int currentPageSize, int pageSize){
    	return (currentPageSize == pageSize)?" selected ":"";
    }
    /**
