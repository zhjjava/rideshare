...
/**
 * This class is used along with query request to specify the pagenation of
...
//	protected QueryReq initQueryReq() {
//		QueryReq queryReq = new QueryReq();
//		queryReq.setSortCriterion(getSortCriterion());
//		queryReq.setSortDirection(getSortDirection());
//		if (StringUtils.isNotBlank(getSortCriterion())) {
//			queryReq.setOrderBy(getSortCriterion() + " " + getSortDirection());
//		}
//		return queryReq;
//	}	
