                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="page-header">
         			 	...
         			 	<form:form id="loginForm" name="loginForm" method="post" action="editUser.do" modelAttribute="sysUser" cssClass="form-horizontal" role="form">
                           <form:errors cssStyle="color:red"></form:errors><br/>
                            ...
                            <div class="form-group">
                   			...
                   			<!-- End .form-group  -->
                   			<div class="form-group">
                                <label class="col-md-2 control-label" for="Employee ID">Employee ID：</label>
                                <div class="col-md-6">
